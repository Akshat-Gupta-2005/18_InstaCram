...
│   │   ├── tests/                     global-setup.ts (builds a fresh test DB) · helpers.ts · feed.test.ts · account.test.ts · resolve.test.ts (the lock proven able to fail, P35) · expansion.test.ts (job lifecycle) · fakes.ts (Qdrant + embeddings stand-ins; CI has neither)
