...
3. **W6 (client) is in progress**, no longer blocked — the framework question closed on 2026-09-17 with one Expo codebase. What remains there: run it on a phone, the local-storage mirror (2b.3), and Google sign-in when credentials exist.
